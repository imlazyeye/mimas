...
```admonish note title="Your API in the editor"
The [language server](./introduction/lsp.md) checks scripts against your API once your host has run through cargo. See [Host APIs](./introduction/lsp.md#host-apis).
```
